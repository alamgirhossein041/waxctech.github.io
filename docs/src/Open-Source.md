...
# open source search
[145 companies on low code ](https://pinver.medium.com/decoding-the-no-code-low-code-startup-universe-and-its-players-4b5e0221d58b)
[official github statistics](https://octoverse.github.com/)
[Github ranking of project by topics](https://github-serendipity.github.io/repo/sindresorhus___awesome-nodejs)
[github: project, language, users, category & label](https://gitplanet.com/categories)
[kandi](https://kandi.openweaver.com/home)


# runa capital
[nocode](https://medium.com/runacapital/no-code-no-code-everywhere-a4f55df4b30c)
[db](https://medium.com/runacapital/open-source-analysis-and-os-databases-1eb1fe840719)
[ROSS Index: shows the fastest-growing open-source startups, every quarter](https://runacap.com/ross-index/)
